...
class Data {
  ...
  static List<StatItemData> statItemsData = [
    StatItemData(value: 15, subtitle: StringConst.MASSIVE_PROJ),
    StatItemData(value: 20, subtitle: StringConst.MED_PROJECTS),
    StatItemData(value: 550, subtitle: StringConst.SMALL_PROJ),
